sap.ui.define([
		"kl-ee/KL-EE/controller/BaseController",
		"sap/ui/model/json/JSONModel",
		"sap/ui/model/Filter",
		"sap/ui/model/FilterOperator",
		"sap/m/GroupHeaderListItem",
		"sap/ui/Device",
		"kl-ee/KL-EE/model/formatter",
		"kl-ee/KL-EE/model/grouper",
		...
		return BaseController.extend("kl-ee.KL-EE.controller.Master", {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("kl-ee.KL-EE.view.ViewSettingsDialog", this);
			...
			onConfirmViewSettingsDialog : function (oEvent) {
				...
				aFilterItems.forEach(function (oItem) {
					switch (oItem.getKey()) {
						case "Filter1" :
							aFilters.push(new Filter("Price/Amount", FilterOperator.LE, 100));
							break;
						case "Filter2" :
							aFilters.push(new Filter("Price/Amount", FilterOperator.GT, 100));
							break;
						default :
							break;
					}
			...
			_onMasterMatched :  function() {
				this.getOwnerComponent().oListSelector.oWhenListLoadingIsDone.then(
					function (mParams) {
						...
						var sObjectId = mParams.firstListitem.getBindingContext().getProperty("ArticleID");
			...
			_showDetail : function (oItem) {
				...
				this.getRouter().navTo("object", {
					objectId : oItem.getBindingContext().getProperty("ArticleID")
				}, bReplace);
			},
