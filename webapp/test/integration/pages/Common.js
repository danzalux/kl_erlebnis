sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("kl-ee/KL-EE/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("kl-ee.KL-EE.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["kl-ee/KL-EE/localService/mockserver"], function (mockserver) {
