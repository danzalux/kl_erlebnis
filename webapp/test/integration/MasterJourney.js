...
sap.ui.define([
	...
	opaTest("MasterList Filtering on Price/Amount less than 100", function(Given, When, Then) {

		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
			and.iSelectListItemInViewSettingsDialog("<Price/Amount>").
			and.iSelectListItemInViewSettingsDialog("<100 <Price/Currency>").
	...
	opaTest("MasterList Filtering on Price/Amount more than 100", function(Given, When, Then) {
		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
			and.iSelectListItemInViewSettingsDialog(">100 <Price/Currency>").
			and.iPressOKInViewSelectionDialog();
